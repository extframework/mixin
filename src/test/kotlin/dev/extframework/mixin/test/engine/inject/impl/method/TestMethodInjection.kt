package dev.extframework.mixin.test.engine.inject.impl.method
...
import dev.extframework.mixin.engine.util.LocalTracker
...
class TestMethodInjection {
    ...
    fun `Test build uber method`() {
        ...
        val method = injector.buildUberMethod(
            ...
            listOf(
                ...
                MethodInjectionData.buildData(it, setOf())
            }
        )
    ...
    fun `Test remapping`() {
        ...
        val injection =
            injector.buildMethodCall(LocalTracker.calculateFor(method), 0, Method("aMethod(IJZLjava/lang/String;)Ljava/lang/String;"))
    ...
    fun `Test total remapping`() {
        ...
        val transformed = engine.transform(classNode(MethodDest::class))
